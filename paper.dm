...
/obj/item/paper/starfarer_lore1
	name = "Old Paper"
	info = "We have been cut off from Nanotrasen communications for months now. The botany section of the station has broke beyond repair, due to an electrical failure. We've been using the survival rations for food for a few weeks, but we're starting to run out. <br> The thing is, I wonder as I know the end is near for us, why were we sent to this planet really?"