...
/obj/structure/poster/happiness
	name = "Unnerving Picture"
	desc = "The pictrue's faded, but the image of a person laughing crazily is still there. Why would someone make this?"
	icon_state = "happiness"

/obj/structure/poster/poster_pray
	name = "Pray"
	desc = "A poster showing some technique of a long-forgotten religion."
	icon_state = "poster_pray"

/obj/structure/poster/colony
	name = "Soon We Shall Expand!"
	desc = "A poster showing a space station orbiting a planet, sending shuttles down to it."
	icon_state = "colony"

/obj/structure/poster/leviathan
	name = "The Leviathan"
	desc = "A poster showing a person standing in front of a window, looking out to a deep blue planet."
